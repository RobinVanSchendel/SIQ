...
public class createMergeCommandsShark {
	...
	public static void main(String[] args) throws IOException {
		...
		File dir = new File("Z:\\Datasets - NGS, UV_TMP, MMP\\Targeted Sequencing\\Hartwig\\GenomeScan107536\\raw\\");
		File barcodeSamples = new File("Z:\\Datasets - NGS, UV_TMP, MMP\\Targeted Sequencing\\Hartwig\\GenomeScan107536\\107536_JavaSamples.txt");
		
		
		String linuxInputDir = "/exports/humgen/rvanschendel/TargetedSequencingGenomeScan107536/";
		String linuxOutputDir = "/exports/humgen/rvanschendel/TargetedSequencingGenomeScan107536/rawMerged/";
		String runPattern = "107536-001-[0-9]+_";
	...
	private static HashMap<String, String> createSampleBarcodeHash(File barcodeSamples, boolean rcSeq) {
		if(!barcodeSamples.exists()) {
			System.err.println("barcodeSamples file does not exist: "+barcodeSamples.getAbsolutePath());
			System.exit(1);
		}
