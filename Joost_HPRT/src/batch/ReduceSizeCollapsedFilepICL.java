...
public class ReduceSizeCollapsedFilepICL {

	public static void main(String[] args) throws FileNotFoundException {
		
		String setNameFile = "pICL_sets.txt";
		String fileNamesFile = "pICL_Samples.txt";
		
		int minimumCounts = 2;
		int maxPosDeviation = 15;
		final int minSizeInward = 30;
		
		File file = new File("E:/Project_Hartwig/20180801_pICL_all_1_2.txt");
		...
		HashMap<String, String> countMap = UtilsReduce.ReadInFileNamesChanges(new File(setNameFile));
		System.out.println("read ReadInFileNamesChanges");
		System.out.println("reading in countPositions");
		ArrayList<SetAndPosition> pos = UtilsReduce.countPositions(file, countMap, index, "File", "matchStart", "matchEnd", "countEvents");
